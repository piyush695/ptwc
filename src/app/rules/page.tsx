...
const SECTIONS = [
  ...
  },
  {
    id: 'account', title: '2. Trading Account', rules: [
      'All participants receive a standardized $10,000 USD funded demo-performance account.',
  ...
  },
  {
    id: 'scoring', title: '3. Scoring & Advancement', rules: [
      'Qualifier scoring: Net Return % on the $10,000 account over the qualifier period (Jun 1–12).',
      'The trader with the highest net return % per country advances to the H2H bracket.',
      'A minimum of 10 completed trades is required to be eligible for advancement.',
  ...
  },
  {
    id: 'drawdown', title: '4. Drawdown Limits', rules: [
      'Daily Drawdown Limit: 8% of the starting account balance for that day.',
      'Total Drawdown Limit: 12% of the initial account balance ($10,000).',
  ...
  },
  {
    id: 'trading', title: '5. Trading Rules', rules: [
      'Maximum leverage: 1:30 across all rounds and instruments.',
      'Maximum position size: 5% of account balance per individual position.',
      'Eligible instruments: Major and minor FX pairs, Gold (XAUUSD), Silver (XAGUSD), US30, NAS100, S&P500, Crude Oil (USOIL).',
  ...
  },
  {
    id: 'prizes', title: '7. Prizes', rules: [
      'Grand Champion (1st Place): $60,000 USD, paid within 14 business days of the Grand Final.',
      'Runner-Up (2nd Place): $25,000 USD.',
      'Semi-Finalists (3rd–4th Place): $7,500 USD each.',
      'Quarter-Finalists (5th–8th Place): $3,500 USD each.',
  ...
  },
  {
    id: 'general', title: '8. General', rules: [
      ...
      'The Grand Final is scheduled for July 18, 2026 and may be rescheduled at Hola Prime\'s discretion.',
    ],
  },
]
    ...
    <div style={{ background: 'var(--black)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '120px 32px 80px' }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <p style={{ fontSize: 16, color: 'var(--gray2)', lineHeight: 1.7 }}>Effective from May 1, 2026. Last updated April 28, 2026.</p>
