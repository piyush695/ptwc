...
const GRAND_FINAL = new Date('2026-07-18T10:00:00Z')
...
export default function HeroSection() {
  const { days, hours, minutes, seconds } = useCountdown(GRAND_FINAL)
    ...
    <section style={{
      ...
      <div style={{
        ...
        <p className="animate-fade-up delay-2" style={{
          ...
          live on stage in <strong style={{ color: 'var(--white)' }}>Dubai, July 18 2026.</strong>
        </p>
        ...
        <div className="animate-fade-up delay-3" style={{ marginBottom: 48 }}>
          ...
          <div style={{
            ...
            JULY 18, 2026 · LIVE EVENT · DUBAI, UAE
          </div>
        </div>
        ...
        <div className="animate-fade-up delay-5" style={{
          ...
          {[
            { value:'$100K',  label:'Prize Pool',   icon:'💰' },
            { value:'32',     label:'Countries',    icon:'🌍' },
            { value:'2,400+', label:'Registered',   icon:'👥' },
            { value:'$10K',   label:'Funded Acc',   icon:'💳' },
            { value:'Jul 18', label:'Grand Final',  icon:'📅' },
          ].map((s, i) => (
            <div key={s.label} style={{
              ...
              <div style={{ fontFamily:'var(--font-display)', fontWeight:900, fontSize:22, color:'var(--white)', lineHeight:1 }}>{s.value}</div>
              <div style={{ fontFamily:'var(--font-display)', fontWeight:700, fontSize:10, letterSpacing:'0.18em', textTransform:'uppercase', color:'var(--gray3)', marginTop:4 }}>{s.label}</div>
            </div>
          ))}
        </div>
